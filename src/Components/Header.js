                            ...
                            <ul className="nav navbar-nav">
                                ...
                                <li className="dropdown messages-menu">
                                    ...
                                    <ul className="dropdown-menu">
                                        ...
                                        <li className="footer">
                                            <a href="fake">See All Messages</a>
                                        </li>
                                    </ul>
                                </li>
                                            ...
                                            <ul className="menu">
                                                ...
                                                <li>
                                                    <a href="fake">
                                                        ...
                                                        here that may not fit
                                                        into the page and may
                                        ...
                                        <li className="user-body">
                                            <div className="row">
                                                <div className="col-xs-4 text-center">
                                                    <a href="fake">Followers</a>
                                                </div>
                                                <div className="col-xs-4 text-center">
                                                    <a href="fake">Sales</a>
                                                </div>
                                                <div className="col-xs-4 text-center">
                                                    <a href="fake">Friends</a>
                                                </div>
                                            </div>
                                            {/* /.row */}
                                        </li>
